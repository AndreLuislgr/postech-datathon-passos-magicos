...
Saída: gráficos na pasta "graficos_eda" (criada ao lado deste script)
       resumo textual impresso no console (para colar na apresentação)

Pré-requisito: rode antes o "limpeza_unificacao_pede.py" para gerar os
arquivos "pede_unificado_long.csv" e "pede_unificado_wide.csv" na mesma
pasta deste script.
"""
...
PASTA_SAIDA = "graficos_eda"
os.makedirs(PASTA_SAIDA, exist_ok=True)

df = pd.read_csv("pede_unificado_long.csv")
...
wide = pd.read_csv("pede_unificado_wide.csv")
